...
`});var M={};a(M,{default:()=>Pt});var f,Pt,L=o(()=>{U();({Context:f}=Shopware),Pt={template:q,inject:["acl","repositoryFactory"],props:{userId:{type:String,required:!1,default:null},isUserLoading:{type:Boolean,required:!1,default:!1}},data(){return{heptacomAdminOpenAuthLoading:!0,heptacomAdminOpenAuthClients:[]}},computed:{heptacomAdminOpenAuthClientsRepository(){return this.repositoryFactory.create("heptacom_admin_open_auth_client")},heptacomAdminOpenAuthHttpClient(){return this.heptacomAdminOpenAuthClientsRepository.httpClient},isMe(){return Shopware.Store.get("session").currentUser.id===this.userId}},watch:{isUserLoading:{handler(){this.loadHeptacomAdminOpenAuth().then()}}},created(){this.loadHeptacomAdminOpenAuth().then()},methods:{async loadHeptacomAdminOpenAuth(){if(this.isUserLoading||this.userId===null)return;this.heptacomAdminOpenAuthLoading=!0,this.heptacomAdminOpenAuthClients=[];let e=this.heptacomAdminOpenAuthClientsRepository.buildHeaders(f.api),t=await this.heptacomAdminOpenAuthHttpClient.get("/_admin/open-auth/client/list",{headers:e,params:{userId:this.userId}});this.heptacomAdminOpenAuthClients=t.data.data,this.heptacomAdminOpenAuthLoading=!1},async redirectToLoginMask(e){let t=window.location.pathname+window.location.search+window.location.hash,i=this.heptacomAdminOpenAuthClientsRepository.buildHeaders(f.api),n=await this.heptacomAdminOpenAuthHttpClient.post(`/_action/open-auth/${e}/connect?redirectTo=${encodeURIComponent(t)}`,{},{headers:i});window.location.href=n.data.target},async revokeHeptacomAdminOpenAuthUserKey(e){let t=this.heptacomAdminOpenAuthClientsRepository.buildHeaders(f.api);await this.heptacomAdminOpenAuthHttpClient.post(`/_action/open-auth/${e}/disconnect`,{},{headers:t}),await this.loadHeptacomAdminOpenAuth()}}}});var E,j=o(()=>{E=`{% block heptacom_admin_open_auth_role_assignment_action_config %}
    ...
    ></sw-entity-multi-id-select>
{% endblock %}
`});var H={};a(H,{default:()=>Dt});var Dt,N=o(()=>{j();Dt={template:E,inject:["repositoryFactory"],props:{client:{required:!0,type:Object},rule:{required:!0,type:Object}},computed:{aclRoleRepository(){return this.repositoryFactory.create("acl_role")}}}});var z,B=o(()=>{z=`{% block heptacom_admin_open_auth_client_rule_container %}
    <div>
...
{% endblock %}
`});var me=o(()=>{});var he={};a(he,{default:()=>Qt});var Gt,Wt,Zt,b,Qt,ue=o(()=>{ce();me();({Context:Gt,Data:Wt,Mixin:Zt}=Shopware),{Criteria:b}=Wt,Qt={template:pe,inject:["acl","repositoryFactory"],mixins:[Zt.getByName("listing")],data(){return{isLoading:!0,items:null}},created(){this.getList()},computed:{clientRepository(){return this.repositoryFactory.create("heptacom_admin_open_auth_client")},clientCriteria(){let e=new b,t=this.getMainListingParams();return e.addAssociation("userKeys"),e.setLimit(t.limit),e.setPage(t.page),e.addSorting(b.sort(t.sortBy||"name",t.sortDirection||"ASC")),t.term&&t.term.length&&e.addFilter(b.contains("name",t.term)),e},columns(){return[{property:"active",label:this.$t("heptacom-admin-open-auth-client.pages.listing.columns.active"),allowResize:!1,width:"50px"},{property:"name",label:this.$t("heptacom-admin-open-auth-client.pages.listing.columns.name"),routerLink:"heptacom.admin.open.auth.client.edit"},{property:"provider",label:this.$t("heptacom-admin-open-auth-client.pages.listing.columns.provider")},{property:"userKeys.length",label:this.$t("heptacom-admin-open-auth-client.pages.listing.columns.users"),width:"100px"},{property:"createdAt",label:this.$t("heptacom-admin-open-auth-client.pages.listing.columns.createdAt"),width:"200px"}]},dateFilter(){return Shopware.Filter.getByName("date")}},methods:{getList(){return this.loadData()},loadData(){this.isLoading=!0,this.loadClients().then(()=>{this.isLoading=!1})},loadClients(){return this.items=null,this.clientRepository.search(this.clientCriteria,Gt.api).then(e=>{this.items=e})},getLoginColor(e){return e.active?e.login?"#00cc00":"#cc0000":"#333333"},getConnectColor(e){return e.active?e.connect?"#00cc00":"#cc0000":"#333333"}}}});var we,Ae=o(()=>{we=`{% block heptacom_admin_open_auth_provider_cidaas_settings %}
...
{% endblock %}
`});var ye={};a(ye,{default:()=>ni});var ni,ke=o(()=>{Ae();ni={template:we,props:{item:{required:!0}},watch:{item(e){e.config.scopes||(e.config.scopes=[])}}}});var Oe,Ce=o(()=>{Oe=`{% block heptacom_admin_open_auth_provider_github_settings %}
    <mt-card position-identifier="heptacom-admin-open-auth-provider-github-settings">
        <mt-text-field
            :label="$t('heptacomAdminOpenAuthClient.providerFields.github.clientId')"
            v-model="item.config.clientId"
        ></mt-text-field>
        <mt-password-field
            :label="$t('heptacomAdminOpenAuthClient.providerFields.github.clientSecret')"
            v-model="item.config.clientSecret"
        ></mt-password-field>
        <sw-tagged-field
            :label="$t('heptacomAdminOpenAuthClient.providerFields.github.additionalScopes')"
            v-model:value="item.config.scopes"
        ></sw-tagged-field>
    </mt-card>
{% endblock %}
`});var xe={};a(xe,{default:()=>ri});var ri,Se=o(()=>{Ce();ri={template:Oe,props:{item:{required:!0}}}});var Pe,$e=o(()=>{Pe=`{% block heptacom_admin_open_auth_client_google_cloud_settings %}
    <mt-card
...
{% endblock %}
`});var Fe={};a(Fe,{default:()=>si});var si,Re=o(()=>{$e();si={template:Pe,props:{item:{required:!0}},watch:{item(e){e.config.scopes||(e.config.scopes=[])}}}});var qe,Ue=o(()=>{qe=`{% block heptacom_admin_open_auth_provider_jira_settings %}
...
{% endblock %}
`});var Me={};a(Me,{default:()=>ci});var ci,Le=o(()=>{Ue();ci={template:qe,props:{item:{required:!0}}}});var De,Te=o(()=>{De=`{% block heptacom_admin_open_auth_provider_jumpcloud_settings %}
    ...
    {% endblock %}
{% endblock %}
`});var Ie={};a(Ie,{default:()=>mi});var mi,je=o(()=>{Te();mi={template:De,props:{item:{required:!0}},data(){return{availableProperties:["firstName","lastName","email","timezone","locale","roles"]}},watch:{item(e){e.config.attributeMapping||(e.config.attributeMapping={})}}}});var He,Ee=o(()=>{He=`{% block heptacom_admin_open_auth_provider_keycloak_settings %}
    <mt-card
...
{% endblock %}
`});var Ne={};a(Ne,{default:()=>ui});var ui,Be=o(()=>{Ee();ui={template:He,props:{item:{required:!0}},data(){return{jsonPlaceholder:JSON.stringify({realm:"master","auth-server-url":"https://keycloak.my-company.com/auth/","ssl-required":"external",resource:"my-client",credentials:{secret:"abcdefghijgklmnopqrstuvwxyz"},"confidential-port":0},null,"	")}},watch:{item(e){e.config.scopes||(e.config.scopes=[])}}}});var Ke,ze=o(()=>{Ke=`{% block heptacom_admin_open_auth_provider_microsoft_entra_id_oidc_settings %}
    <mt-card
...
{% endblock %}
`});var Xe={};a(Xe,{default:()=>gi});var gi,Je=o(()=>{ze();gi={template:Ke,props:{item:{required:!0}},watch:{item(e){e.config.scopes||(e.config.scopes=[])}}}});var We,Ge=o(()=>{We=`{% block heptacom_admin_open_auth_provider_okta_settings %}
...
{% endblock %}
`});var Ze={};a(Ze,{default:()=>vi});var vi,Qe=o(()=>{Ge();vi={template:We,props:{item:{required:!0}},watch:{item(e){e.config.scopes||(e.config.scopes=[])}}}});var Ve,Ye=o(()=>{Ve=`{% block heptacom_admin_open_auth_provider_onelogin_settings %}
    <mt-card
...
{% endblock %}
`});var et={};a(et,{default:()=>Ai});var Ai,tt=o(()=>{Ye();Ai={template:Ve,props:{item:{required:!0}},watch:{item(e){e.config.scopes||(e.config.scopes=[])}}}});var ot,it=o(()=>{ot=`{% block sw_condition_value_content %}
    <div
...
{% endblock %}
`});var nt=o(()=>{});var at={};a(at,{default:()=>Ci});var yi,ki,Ci,rt=o(()=>{it();nt();({Component:yi}=Shopware),{mapPropertyErrors:ki}=yi.getComponentHelper(),Ci={template:ot,computed:{requestUrl:{get(){return this.ensureValueExist(),this.condition.value.requestUrl||null},set(e){this.ensureValueExist(),this.condition.value={...this.condition.value,requestUrl:e}}},jmesPathExpression:{get(){return this.ensureValueExist(),this.condition.value.jmesPathExpression||null},set(e){this.ensureValueExist(),this.condition.value={...this.condition.value,jmesPathExpression:e}}},...ki("condition",["value.requestUrl","value.jmesPathExpression"]),currentError(){return this.conditionValueRequestUrlError||this.conditionValueJmesPathExpressionError}}}});var st,lt=o(()=>{st=`{% block sw_condition_value_content %}
    <div
...
{% endblock %}
`});var dt=o(()=>{});var ct={};a(ct,{default:()=>$i});var xi,Si,$i,pt=o(()=>{lt();dt();({Component:xi}=Shopware),{mapPropertyErrors:Si}=xi.getComponentHelper(),$i={template:st,computed:{jmesPathExpression:{get(){return this.ensureValueExist(),this.condition.value.jmesPathExpression||null},set(e){this.ensureValueExist(),this.condition.value={...this.condition.value,jmesPathExpression:e}}},...Si("condition",["value.jmesPathExpression"]),currentError(){return this.conditionValueJmesPathExpressionError}}}});var ht,mt=o(()=>{ht=`{% block heptacom_admin_open_auth_provider_open_id_connect_settings %}
    <mt-card
...
{% endblock %}
`});var ut={};a(ut,{default:()=>Fi});var Fi,_t=o(()=>{mt();Fi={template:ht,props:{item:{required:!0}},watch:{item(e){e.config.scopes||(e.config.scopes=[])}}}});var ft,gt=o(()=>{ft=`{% block heptacom_admin_open_auth_provider_saml2_settings %}
    <div>
...
`;var{Component:Rt}=Shopware;Rt.override("sw-profile-index-general",{template:T,inject:["systemConfigApiService","loginService"],data(){return{denyPasswordLogin:!1,userId:null}},created(){this.systemConfigApiService.getValues("KskHeptacomAdminOpenAuth.config").then(e=>{this.denyPasswordLogin=e["KskHeptacomAdminOpenAuth.config.denyPasswordLogin"]}),this.userId=Shopware.Store.get("session")?.currentUser.id}});var D=`{% block sw_setting_user_detail_card_integrations %}
    ...
    {% parent %}
{% endblock %}
`;var{Component:qt}=Shopware;qt.override("sw-users-permissions-user-detail",{template:D});var I=`{% block sw_settings_user_detail_content_confirm_password_modal_input__confirm_password %}
