...
`});var M={};a(M,{default:()=>Ot});var f,Ot,L=o(()=>{U();({Context:f}=Shopware),Ot={template:q,inject:["repositoryFactory"],props:{userId:{type:String,required:!1,default:null},isUserLoading:{type:Boolean,required:!1,default:!1}},data(){return{heptacomAdminOpenAuthLoading:!0,heptacomAdminOpenAuthClients:[]}},computed:{heptacomAdminOpenAuthClientsRepository(){return this.repositoryFactory.create("heptacom_admin_open_auth_client")},heptacomAdminOpenAuthHttpClient(){return this.heptacomAdminOpenAuthClientsRepository.httpClient},isMe(){return Shopware.Store.get("session").currentUser.id===this.userId}},watch:{isUserLoading:{handler(){this.loadHeptacomAdminOpenAuth().then()}}},created(){this.loadHeptacomAdminOpenAuth().then()},methods:{async loadHeptacomAdminOpenAuth(){if(this.isUserLoading||this.userId===null)return;this.heptacomAdminOpenAuthLoading=!0,this.heptacomAdminOpenAuthClients=[];let e=this.heptacomAdminOpenAuthClientsRepository.buildHeaders(f.api),t=await this.heptacomAdminOpenAuthHttpClient.get("/_admin/open-auth/client/list",{headers:e,params:{userId:this.userId}});this.heptacomAdminOpenAuthClients=t.data.data,this.heptacomAdminOpenAuthLoading=!1},async redirectToLoginMask(e){let t=window.location.pathname+window.location.search+window.location.hash,i=this.heptacomAdminOpenAuthClientsRepository.buildHeaders(f.api),n=await this.heptacomAdminOpenAuthHttpClient.post(`/_action/open-auth/${e}/connect?redirectTo=${encodeURIComponent(t)}`,{},{headers:i});window.location.href=n.data.target},async revokeHeptacomAdminOpenAuthUserKey(e){let t=this.heptacomAdminOpenAuthClientsRepository.buildHeaders(f.api);await this.heptacomAdminOpenAuthHttpClient.post(`/_action/open-auth/${e}/disconnect`,{},{headers:t}),await this.loadHeptacomAdminOpenAuth()}}}});var E,j=o(()=>{E=`{% block heptacom_admin_open_auth_role_assignment_action_config %}
    ...
    ></sw-entity-multi-id-select>
{% endblock %}
`});var H={};a(H,{default:()=>qt});var qt,N=o(()=>{j();qt={template:E,inject:["repositoryFactory"],props:{client:{required:!0,type:Object},rule:{required:!0,type:Object}},computed:{aclRoleRepository(){return this.repositoryFactory.create("acl_role")}}}});var z,B=o(()=>{z=`{% block heptacom_admin_open_auth_client_rule_container %}
    <div>
...
{% endblock %}
`});var ye={};a(ye,{default:()=>ei});var ei,ke=o(()=>{Ae();ei={template:we,props:{item:{required:!0}},watch:{item(e){e.config.scopes||(e.config.scopes=[])}}}});var Oe,Ce=o(()=>{Oe=`{% block heptacom_admin_open_auth_client_google_cloud_settings %}
    <mt-card
...
{% endblock %}
`});var xe={};a(xe,{default:()=>ii});var ii,Se=o(()=>{Ce();ii={template:Oe,props:{item:{required:!0}},watch:{item(e){e.config.scopes||(e.config.scopes=[])}}}});var Pe,$e=o(()=>{Pe=`{% block heptacom_admin_open_auth_provider_jira_settings %}
...
{% endblock %}
`});var Fe={};a(Fe,{default:()=>ni});var ni,Re=o(()=>{$e();ni={template:Pe,props:{item:{required:!0}}}});var qe,Ue=o(()=>{qe=`{% block heptacom_admin_open_auth_provider_jumpcloud_settings %}
    ...
    {% endblock %}
{% endblock %}
`});var Me={};a(Me,{default:()=>ri});var ri,Le=o(()=>{Ue();ri={template:qe,props:{item:{required:!0}},data(){return{availableProperties:["firstName","lastName","email","timezone","locale","roles"]}},watch:{item(e){e.config.attributeMapping||(e.config.attributeMapping={})}}}});var De,Te=o(()=>{De=`{% block heptacom_admin_open_auth_provider_keycloak_settings %}
    <mt-card
...
{% endblock %}
`});var Ie={};a(Ie,{default:()=>si});var si,je=o(()=>{Te();si={template:De,props:{item:{required:!0}},data(){return{jsonPlaceholder:JSON.stringify({realm:"master","auth-server-url":"https://keycloak.my-company.com/auth/","ssl-required":"external",resource:"my-client",credentials:{secret:"abcdefghijgklmnopqrstuvwxyz"},"confidential-port":0},null,"	")}},watch:{item(e){e.config.scopes||(e.config.scopes=[])}}}});var He,Ee=o(()=>{He=`{% block heptacom_admin_open_auth_provider_microsoft_entra_id_oidc_settings %}
    <mt-card
...
{% endblock %}
`});var Ne={};a(Ne,{default:()=>ci});var ci,Be=o(()=>{Ee();ci={template:He,props:{item:{required:!0}},watch:{item(e){e.config.scopes||(e.config.scopes=[])}}}});var Ke,ze=o(()=>{Ke=`{% block heptacom_admin_open_auth_provider_okta_settings %}
...
{% endblock %}
`});var Xe={};a(Xe,{default:()=>mi});var mi,Je=o(()=>{ze();mi={template:Ke,props:{item:{required:!0}},watch:{item(e){e.config.scopes||(e.config.scopes=[])}}}});var We,Ge=o(()=>{We=`{% block heptacom_admin_open_auth_provider_onelogin_settings %}
    <mt-card
...
{% endblock %}
`});var Ze={};a(Ze,{default:()=>ui});var ui,Qe=o(()=>{Ge();ui={template:We,props:{item:{required:!0}},watch:{item(e){e.config.scopes||(e.config.scopes=[])}}}});var Ve,Ye=o(()=>{Ve=`{% block sw_condition_value_content %}
    <div
...
{% endblock %}
`});var et=o(()=>{});var tt={};a(tt,{default:()=>vi});var gi,fi,vi,it=o(()=>{Ye();et();({Component:gi}=Shopware),{mapPropertyErrors:fi}=gi.getComponentHelper(),vi={template:Ve,computed:{requestUrl:{get(){return this.ensureValueExist(),this.condition.value.requestUrl||null},set(e){this.ensureValueExist(),this.condition.value={...this.condition.value,requestUrl:e}}},jmesPathExpression:{get(){return this.ensureValueExist(),this.condition.value.jmesPathExpression||null},set(e){this.ensureValueExist(),this.condition.value={...this.condition.value,jmesPathExpression:e}}},...fi("condition",["value.requestUrl","value.jmesPathExpression"]),currentError(){return this.conditionValueRequestUrlError||this.conditionValueJmesPathExpressionError}}}});var nt,ot=o(()=>{nt=`{% block sw_condition_value_content %}
    <div
...
{% endblock %}
`});var at=o(()=>{});var rt={};a(rt,{default:()=>yi});var Ai,wi,yi,lt=o(()=>{ot();at();({Component:Ai}=Shopware),{mapPropertyErrors:wi}=Ai.getComponentHelper(),yi={template:nt,computed:{jmesPathExpression:{get(){return this.ensureValueExist(),this.condition.value.jmesPathExpression||null},set(e){this.ensureValueExist(),this.condition.value={...this.condition.value,jmesPathExpression:e}}},...wi("condition",["value.jmesPathExpression"]),currentError(){return this.conditionValueJmesPathExpressionError}}}});var dt,st=o(()=>{dt=`{% block heptacom_admin_open_auth_provider_open_id_connect_settings %}
    <mt-card
...
{% endblock %}
`});var ct={};a(ct,{default:()=>Ci});var Ci,pt=o(()=>{st();Ci={template:dt,props:{item:{required:!0}},watch:{item(e){e.config.scopes||(e.config.scopes=[])}}}});var ht,mt=o(()=>{ht=`{% block heptacom_admin_open_auth_provider_saml2_settings %}
    <div>
...
`});var ut={};a(ut,{default:()=>xi});var xi,_t=o(()=>{mt();xi={template:ht,props:{item:{required:!0}},data(){return{selectedMappingTemplate:null,availableProperties:["firstName","lastName","email","timezone","locale","roles"],availableAuthnContexts:["urn:oasis:names:tc:SAML:2.0:ac:classes:unspecified","urn:oasis:names:tc:SAML:2.0:ac:classes:Kerberos","urn:oasis:names:tc:SAML:2.0:ac:classes:Password","urn:oasis:names:tc:SAML:2.0:ac:classes:PasswordProtectedTransport","urn:oasis:names:tc:SAML:2.0:ac:classes:Smartcard","urn:oasis:names:tc:SAML:2.0:ac:classes:SmartcardPKI","urn:oasis:names:tc:SAML:2.0:ac:classes:TLSClient","urn:oasis:names:tc:SAML:2.0:ac:classes:TimeSyncToken","urn:oasis:names:tc:SAML:2.0:ac:classes:X509","urn:federation:authentication:windows"].map(e=>({value:e,label:e.startsWith("urn:oasis:names:tc:SAML:2.0:ac:classes:")?e.substring(39):e})),attributeMappingTemplates:{friendlyNames:{firstName:"givenName",lastName:"surName",email:"emailAddress",roles:"memberOf"},x500:{firstName:"urn:oid:2.5.4.42",lastName:"urn:oid:2.5.4.4",email:"urn:oid:1.2.840.113549.1.9.1",roles:"urn:oid:1.3.6.1.4.1.5923.1.5.1.1"},entraId:{firstName:"http://schemas.xmlsoap.org/ws/2005/05/identity/claims/givenname",lastName:"http://schemas.xmlsoap.org/ws/2005/05/identity/claims/surname",email:"http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress",roles:"http://schemas.microsoft.com/ws/2008/06/identity/claims/role"}}}},computed:{mappingTemplateOptions(){return Object.keys(this.attributeMappingTemplates).map(e=>({value:e,label:this.$t(`heptacomAdminOpenAuthClient.providerFields.saml2.attributeMapping.template.${e}`)}))}},watch:{item(e){e.config.attributeMapping||(e.config.attributeMapping={})}},methods:{onApplyMappingTemplate(e){let t=this.attributeMappingTemplates[e];this.item.config.attributeMapping=Object.assign(this.item.config.attributeMapping,t)}}}});var{Component:v}=Shopware;v.extend("heptacom-admin-open-auth-url-field","sw-url-field",()=>Promise.resolve().then(()=>(O(),C)));v.register("heptacom-admin-open-auth-user-confirm-login",()=>Promise.resolve().then(()=>(R(),F)));v.register("heptacom-admin-open-auth-url-clients",()=>Promise.resolve().then(()=>(L(),M)));var T=`{% block sw_profile_index_general_password %}
    ...
    {% endblock %}
{% endblock %}
`;var{Component:St}=Shopware;St.override("sw-profile-index-general",{template:T,inject:["systemConfigApiService","loginService"],data(){return{denyPasswordLogin:!1,userId:null}},created(){this.systemConfigApiService.getValues("KskHeptacomAdminOpenAuth.config").then(e=>{this.denyPasswordLogin=e["KskHeptacomAdminOpenAuth.config.denyPasswordLogin"]}),this.userId=Shopware.Store.get("session")?.currentUser.id}});var D=`{% block sw_setting_user_detail_card_integrations %}
    <heptacom-admin-open-auth-url-clients
    ...
    {% parent %}
{% endblock %}
`;var{Component:Pt}=Shopware;Pt.override("sw-users-permissions-user-detail",{template:D});var I=`{% block sw_settings_user_detail_content_confirm_password_modal_input__confirm_password %}
